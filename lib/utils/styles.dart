...
class AppStyles {
  static TextStyle get tsFS50CPW600 => GoogleFonts.montserrat(
        fontSize: 50.sp,
  ...
  static TextStyle get tsFS14CFFW600 => GoogleFonts.montserrat(
        color: Colors.white,
        fontSize: 14.sp,
        fontWeight: FontWeight.w600,
      );

  static TextStyle get tsFS14C00W400 => GoogleFonts.montserrat(
        color: color00000000,
        fontSize: 14.sp,
        fontWeight: FontWeight.w400,
      );
  ...
  static TextStyle get tsFS20C00W400 => GoogleFonts.montserrat(
        color: color00000000,
        fontSize: 20.sp,
        fontWeight: FontWeight.w400,
      );
